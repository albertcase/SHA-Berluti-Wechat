<script src="<?php echo Yii::app()->request->baseUrl; ?>/vstyle/shoe/js/PxLoader.js"></script>
<script src="<?php echo Yii::app()->request->baseUrl; ?>/vstyle/shoe/js/swiper.min.js"></script>

<div class="loading ycenter">
	<div class="loadCon">
		<img src="/vstyle/shoe/img/shoe_loading.png" width="100%">
...
<div class="rulePup">
	<a href="javascript:;" class="close">
		<img src="/vstyle/shoe/img/close.png" width="100%">
	</a>
	<div class="ruleCon">
		<h2>条款与细则</h2>
		<p>本次活动“Fasttrack”（“活动”）由Berluti（“主办方”）主办。通过参与该活动，即代表您（“参加者”）同意并接受以下条款与细则的约束：</p>
		<img src="/vstyle/shoe/img/line.png" class="line">
		<h3>一般规则</h3>
...
<div class="section">
	<div class="menu">
		...
		<img src="/vstyle/shoe/img/micon.png" width="100%" class="opacity0">
	</div>
		    ...
		    <div class="swiper-container" id="voteSwiper">
		        <div class="swiper-wrapper">
		            <div class="swiper-slide hover">
						<img src="/vstyle/shoe/img/m.jpg" width="100%">
						<span>花样美男</span>
		            </div>
	...
	<div class="section_foot">
		<a href="javascript:;" class="rulelink"><img src="/vstyle/shoe/img/rule.png" width="100%"></a>
		<img src="/vstyle/shoe/img/slogan.png" width="100%">
		<span class="btn">
			<a href="javascript:"></a>
			<img src="/vstyle/shoe/img/earnBtn.png" width="100%">
		</span>
	</div>
...
<script src="<?php echo Yii::app()->request->baseUrl; ?>/vstyle/shoe/js/main.js"></script>
<script>
$(function(){
    mfun.init();
