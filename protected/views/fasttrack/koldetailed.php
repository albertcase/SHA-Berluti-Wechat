					...
					<div class="swiper-slide">
						<div class="kolBox character">
							...
							<div class="con">
								...
								<center><strong>他眼中的 Fast Track</strong></center>
								<div class="videoArea">
									<div class="videoTab" id="vplay-kol-03"></div>
									<img src="/vstyle/fasttrack/img/poster.jpg" class="opacity0" width="100%">
								</div> 
...
<script>
	$(function(){
		var _id = !"<?php echo $id ?>" ? "0" : "<?php echo $id ?>",
			vArr = ["g03161xq4d1", "a03187advye", "k0320a78m4k"],
			vposter = ["/vstyle/fasttrack/img/video/v1_poster.jpg", "/vstyle/fasttrack/img/video/v2_poster.jpg", "/vstyle/fasttrack/img/video/v3_poster.jpg"];
		...
		var swiper = new Swiper('#kolSwiper', {
        	...
        	onSlideChangeEnd: function(swiper){
        		...
        		if($("#vplay-kol-03 video")[0]){
        			$("#vplay-kol-03 video")[0].pause();
        		}
        	}
		});
		...
		vposterimg.onload=function(){
			...
			pfun.txVideoFun(vArr[2], vposter[2], "vplay-kol-03");
		}
